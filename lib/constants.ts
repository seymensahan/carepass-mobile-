export const APP_NAME = "CAREPASS";
export const APP_VERSION = "1.0.0";
export const APP_SCHEME = "carepass";

export const CAREPASS_ID_PREFIX = "CP-2025-";
...
export const WEBSITE_URL = "https://carepass.cm";

export const ONBOARDING_KEY = "carepass_onboarding_done";
