...
export default function AccessRequestsScreen() {
  ...
  const [carepassId, setCarepassId] = useState("");
  ...
  const requestMutation = useMutation({
    mutationFn: () => doctorService.requestPatientAccess(carepassId, reason),
    onSuccess: (result) => {
      if (result.success) {
      ...
      >
        ...
        {!showForm ? (
          ...
          <View className="bg-white rounded-2xl p-5 mb-5 border border-border">
            ...
            <Text className="text-xs font-medium text-foreground mb-1">CarePass ID du patient</Text>
            <TextInput
              value={carepassId}
              onChangeText={setCarepassId}
            ...
            <View className="flex-row gap-3">
              ...
              <Pressable
                ...
                disabled={!carepassId || requestMutation.isPending}
                className={`flex-1 rounded-xl py-3 items-center ${carepassId ? "bg-primary" : "bg-gray-200"}`}
              >
              ...
              <View key={r.id} className="bg-white rounded-2xl p-4 mb-3" style={s.card}>
                <View className="flex-row items-center mb-3">
                  ...
                  <View className="flex-1">
                    ...
                    <Text className="text-xs text-muted">{r.patientCarepassId}</Text>
                  </View>
              ...
              <View key={g.id} className="bg-white rounded-2xl p-4 mb-3" style={s.card}>
                <View className="flex-row items-center">
                  ...
                  <View className="flex-1">
                    ...
                    <Text className="text-xs text-muted">{g.patientCarepassId}</Text>
                  </View>
